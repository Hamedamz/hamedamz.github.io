...
<template>
<!--  <div class="w-full h-[60vh] opacity-90 absolute px-32 -top-[40vh]">-->
<!--    <div class="w-full h-full blur-[300px] bg-gradient-to-br from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90%"/>-->
